#!/usr/bin/env python3
"""
analisar_complementar.py — Análise complementar da Q2 sobre o experimento complementar
...
ax.set_title("Q2 · SFT LoRA (experimento complementar): a validação satura após ~1,3 época",
...
fig.suptitle("Q2 · experimento complementar: na rodada 3, a resposta encurta (713→284) e a similaridade cai",
