...
_SYS_GROUND = (
    "Você verifica fundamentação factual. Dadas PASSAGENS e uma RESPOSTA, diga se a "
    "RESPOSTA é inteiramente sustentada pelas PASSAGENS. Responda SOMENTE com uma "
    "palavra: GROUNDED (sustentada) ou UNGROUNDED (afirma algo fora das passagens)."
)
